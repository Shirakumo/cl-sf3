...
(define-accessors audio samplerate channels format samples)
...
(define-accessors text encoding text)
...
(define-accessors vector-graphic width height count instructions)
